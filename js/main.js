...
$(function() {
  var bookmark = {
    data: [{
      name: '皓然科技',
      link: 'http://haoranitchina.icoc.me/',
      icon: 'img/log.png',
    }, {
      name: '酷安网',
...
var time = d.getHours();
if (time < 24) {
  document.getElementById("title").innerHTML = "皓然科技搜索导航-万能工具";
}
if (time < 18) {
  document.getElementById("title").innerHTML = "皓然科技搜索导航-万能工具";
}
